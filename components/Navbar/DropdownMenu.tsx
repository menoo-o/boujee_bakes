    ...
    <div className="dropdown-menu">
      ...
      >
        <div className="menu" ref={mainMenuRef} >
          ...
          <ul>
            <MenuItem onClick={() => setActiveMenu('cakes')}>Valentine's Day</MenuItem>
            <MenuItem onClick={() => setActiveMenu('cupcakes')}>Shop Brownies</MenuItem>
            <MenuItem onClick={() => setActiveMenu('bento-cakes')}>Best Sellers</MenuItem>
